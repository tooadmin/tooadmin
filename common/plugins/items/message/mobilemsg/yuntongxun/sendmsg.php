...
/*
//主帐号
$accountSid= '8a48b55148406d4001484a369b340363';
//主帐号Token
$accountToken= 'fb66a9bb44b74572b1cb104e6abf97ae';
//应用Id
$appId='8a48b55148406d4001484a5f21310367';
//请求地址，格式如下，不需要写https://
...
function sendTemplateSMS($to,$datas,$tempId)
{
     ...
     if($result == NULL ) {
       ...
       if($sendResult)  //返回结果为OK1表示成功1条，OK2 表示成功二条，以此类推
	{
		return array("result"=>true,"msg"=>"发送成功!");
	}
	else 
	{
		return array("result"=>false,"msg"=>"发送失败!".$errorMsg); //返回错误的详细提示
	}
...
$paramArr = array();
for($i=1; $i<=5; $i++) {
	if(isset($_POST["param".$i]) && $_POST["param".$i] != "null_param") {
		$paramArr[] = $_POST["param".$i];	
	} else {
		break;
	}
}
...
$softVersion = $_POST["softVersion"];

$res = sendTemplateSMS($mobile,$paramArr,$yun_id);	

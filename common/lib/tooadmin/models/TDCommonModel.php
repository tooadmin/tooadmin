...
class TDCommonModel extends TDActiveRecord {
	/* private $tmpTableName = '';
	  public function __construct($table) {
	  if(TDSessionData::checkIsTableName($table)) {
	...
	/*
	  private static $tmpTableName = '';
	  public function __construct($table) {
	  //echo ">>".$table."<br/>";
	  if(TDSessionData::checkIsTableName($table)) {
	  self::$tmpTableName = $table;
	  $this->tableName = self::$tmpTableName;
	  parent::__construct();
	  } else {
	  parent::__construct($table);
	  }
	  ...
	  //public function __construct($table) { $this->tableName = "jsj_trust_buy_items"; parent::__construct($table); }
	 */
